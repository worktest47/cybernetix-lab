      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <div className="flex items-center mb-4">
                <div className="bg-[#1bd095] rounded-full w-10 h-10 flex items-center justify-center mr-2">
                  <span className="text-lg font-bold text-white">DL</span>
                </div>
                <span className="text-xl font-bold">Dev Labs</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-300 hover:text-[#1bd095] transition-colors">Home</a></li>
                <li><a href="#about" className="text-gray-300 hover:text-[#1bd095] transition-colors">About Us</a></li>
                <li><a href="#services" className="text-gray-300 hover:text-[#1bd095] transition-colors">Services</a></li>
                <li><a href="#work" className="text-gray-300 hover:text-[#1bd095] transition-colors">Our Work</a></li>
                <li><a href="#contact" className="text-gray-300 hover:text-[#1bd095] transition-colors">Contact</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-700 pt-8 text-center">
            <p>© {new Date().getFullYear()} Dev Labs. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
